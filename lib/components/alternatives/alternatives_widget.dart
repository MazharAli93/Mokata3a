...
export 'alternatives_model.dart';
...
class _AlternativesWidgetState extends State<AlternativesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlternativesModel());
  }
            ...
            children: [
              ...
              Padding(
                ...
                child: Builder(
                  builder: (context) {
                    final alternatives =
                        containerProductsRecord.alternatives.toList();
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, alternativesIndex) {
                        final alternativesItem =
