                          ...
                          onPressed: () async {
                            ...
                            unawaited(
                              () async {
                                await launchUrl(Uri(
                                    scheme: 'mailto',
                                    path: 'mazhar.na.ali@gmail.com',
                                    query: {
                                      'subject': 'Mokata3a Mobile App',
                                      'body':
                                          'From:  ${_model.nameTextController.text} $currentUserEmail Subject:  ${_model.subjectTextController.text} Message:   ${_model.messageTextController.text}',
                                    }
                                        .entries
